...
export default function App() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse 900px 650px at 10% -8%, rgba(34,211,197,0.16), transparent 60%), radial-gradient(ellipse 800px 650px at 100% 0%, rgba(124,92,255,0.14), transparent 55%), radial-gradient(ellipse 700px 500px at 50% 115%, rgba(34,211,197,0.10), transparent 55%), var(--bg)",
        color: "var(--text)",
    ...
    >
      <style>{`
        ...
        :root {
          --bg: #0a0f1c; --surface: #121a2c; --surface2: #1b2540;
          --accent: #22d3c5; --accent2: #7c5cff; --gold: #ffb020;
          --good: #34d399; --bad: #f43f5e;
          --text: #edf1f7; --muted: #8391ab;
        }
        ...
        .btn-grad {
          ...
          color: #061018;
          box-shadow: 0 6px 20px -6px rgba(34,211,197,0.5);
          animation: bg-drift 6s ease infinite;
        }
        .btn-grad:hover { filter: brightness(1.08); transform: translateY(-2px); box-shadow: 0 10px 26px -6px rgba(34,211,197,0.65); }
        .btn-grad:active { transform: translateY(0); }
        .card-glow {
          position: relative;
          box-shadow: 0 0 0 1px rgba(34,211,197,0.12), 0 12px 30px -18px rgba(0,0,0,0.6);
        ...
        .slot-btn:hover { background: linear-gradient(135deg, var(--accent), var(--accent2)) !important; color: #061018 !important; box-shadow: 0 0 14px -2px var(--accent); }
        input[type="text"], input[type="number"], input[type="password"], textarea {
          background: var(--surface2); border: 1px solid #2a3555; color: var(--text);
          border-radius: 8px; padding: 8px 10px; font-family: 'Space Mono', monospace;
          transition: border-color 0.15s ease, box-shadow 0.15s ease;
        }
        input:focus, textarea:focus { outline: none; border-color: var(--accent); box-shadow: 0 0 0 3px rgba(34,211,197,0.18); }
      `}</style>
      ...
      <div className="w-full flex flex-col items-center" style={{ maxWidth: 720 }}>
        <button
          ...
          title="Strona główna"
        >
          <img src={logoImg} alt="Hitsteriada" style={{ height: 92, filter: "drop-shadow(0 0 18px rgba(34,211,197,0.35))" }} />
        </button>
            ...
            {isHost ? (
              <section className="w-full rounded-2xl p-5 card-glow" style={{ background: "var(--surface)", border: "1px solid #22304f" }}>
                ...
                <button
                  ...
                  className="w-full mt-4 py-3 rounded-xl text-lg font-bold flex items-center justify-center gap-2 btn-grad"
