  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .hs-bg { content: ""; position: absolute; inset: -24px -24px auto -24px; height: 620px; background: url(${homeBg}) center top / cover no-repeat; opacity: 0.5; z-index: 0; pointer-events: none; border-radius: 24px; -webkit-mask-image: linear-gradient(to bottom, black 55%, transparent 100%); mask-image: linear-gradient(to bottom, black 55%, transparent 100%); }
